...
const Header = () => {
  return (
    ...
    >
      ...
      Delicias  Sabores Tradicionales <br /><span className="text-orange-400 animate-pulse-slow hover:animate-none ">    que Te Transportan</span>
        </h1>
        ...
        <button  className="md:px-6 px-3 py-2 animate-bounce-slow hover:animate-none ring-2 ring-orange-500  bg-orange-400 uppercase font-medium transition-colors ease-in-out hover:scale-105 hover:bg-white hover:text-black text-white rounded-xl">
